...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/ayang_id"), InlineKeyboardButton("Support Group", url="https://t.me/Sharkuserbot")], [InlineKeyboardButton("Bots Channel", url="https://t.me/blvckcards")], [InlineKeyboardButton("Source Code", url="https://t.me/kepaksaa")]]),
...
async def VidWatermarkAdder(bot, cmd):
	...
	output_vid = main_file_name + "_[" + str(cmd.from_user.id) + "]_[" + str(time.time()) + "]_[@BLVCKCARDS's]" + ".mp4"
	...
	if (int(file_size) > 2097152000) and (Config.ALLOW_UPLOAD_TO_STREAMTAPE is True) and (Config.STREAMTAPE_API_USERNAME != "NoNeed") and (Config.STREAMTAPE_API_PASS != "NoNeed"):
		...
		try:
			...
			print(f"Error: {e}")
			await editable.edit("Sorry, Something went wrong!\n\nCan't Upload to Streamtape. You can report at [Support Group](https://t.me/SharkUserbot).")
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Blvckcards).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [Support Group](https://t.me/Blvckcards).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Ayang_id"), InlineKeyboardButton("Support Group", url="https://t.me/SharkUserbot")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Blvckcards")]]),
			disable_web_page_preview=True
		)
		...
		if Config.UPDATES_CHANNEL:
			...
			try:
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [Support Group](https://t.me/sharkuserbot).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
